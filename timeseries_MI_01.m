function varargout = timeseries_MI_01(varargin)
% TIMESERIES_MI_01 MATLAB code for timeseries_MI_01.fig
%      TIMESERIES_MI_01, by itself, creates a new TIMESERIES_MI_01 or raises the existing
%      singleton*.
%
%      H = TIMESERIES_MI_01 returns the handle to a new TIMESERIES_MI_01 or the handle to
%      the existing singleton*.
%
%      TIMESERIES_MI_01('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TIMESERIES_MI_01.M with the given input arguments.
%
%      TIMESERIES_MI_01('Property','Value',...) creates a new TIMESERIES_MI_01 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before timeseries_MI_01_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to timeseries_MI_01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help timeseries_MI_01

% Last Modified by GUIDE v2.5 08-Jul-2016 16:01:36
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @timeseries_MI_01_OpeningFcn, ...
                   'gui_OutputFcn',  @timeseries_MI_01_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before timeseries_MI_01 is made visible.
function timeseries_MI_01_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to timeseries_MI_01 (see VARARGIN)

% Choose default command line output for timeseries_MI_01
...
% so window can get raised using timeseries_MI_01.
...
% UIWAIT makes timeseries_MI_01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = timeseries_MI_01_OutputFcn(hObject, eventdata, handles)
